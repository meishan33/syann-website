...
Return ONLY valid JSON in this exact structure:
{
  ...
  "analysisSummary": "Paragraph 1 (3–4 sentences): Open by addressing the customer warmly by their first name. Explain what their elemental profile reveals about their current energy. Describe the strengths and qualities of their dominant element in plain, relatable language. Mention how these strengths naturally show up in their everyday life.\\n\\nParagraph 2 (3–4 sentences): Explain why nurturing their weaker element will create greater harmony and wholeness. Describe the qualities and potential this element represents when it is in balance. Briefly mention that the recommended crystals have been chosen to gently support this intention. Close with an encouraging, uplifting sentence about moving toward greater balance.",
  "crystalExplanations": {

      ...
      options={{
        ...
        appearance: {
          ...
          rules: {
            ...
            '.Tab--selected': { border: '2px solid #B08B57', backgroundColor: '#EDD9B0', boxShadow: '0 2px 10px rgba(176,139,87,0.3)' },
            ...
            '.Block': { backgroundColor: '#EDD9B0', border: '1px solid #D9C4A8' },
          },
        },
      }}
    >

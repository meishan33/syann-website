      ...
      options={{
        ...
        appearance: {
          ...
          rules: {
            ...
            '.Input': { padding: '10px 12px', border: '1px solid #E5DDD5', boxShadow: 'none', backgroundColor: '#FFFFFF' },
            ...
            '.Tab--selected': { border: '2px solid #B08B57', backgroundColor: '#EDD9B0', boxShadow: '0 2px 10px rgba(176,139,87,0.3)', color: '#4A3A32' },
            '.Tab--selected:focus': { border: '2px solid #B08B57', backgroundColor: '#EDD9B0', boxShadow: '0 2px 10px rgba(176,139,87,0.3)' },
            '.Tab:hover': { backgroundColor: '#F5EAD8', border: '1.5px solid #D9C4A8' },
            '.TabLabel': { color: '#9A8573' },
            '.TabLabel--selected': { color: '#4A3A32', fontWeight: '600' },
            '.TabIcon--selected': { fill: '#B08B57' },
            '.Block': { backgroundColor: '#EDD9B0', border: 'none' },
            '.BlockDivider': { backgroundColor: '#D9C4A8' },
          },
        },
      }}
    >

  ...
  return (
    <main style={{ background: '#F6F1EB', ...BODY }}>
      ...
      <section style={{ position: 'relative', height: 280, overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: '0 24px' }}>
          ...
          <p style={{ ...BODY, fontSize: 13, fontWeight: 300, color: '#7A6355', lineHeight: 1.75, maxWidth: 380, margin: 0 }}>
            You've been signed out.<br />Your crystals are always here when you return.
          </p>
      ...
      <section style={{ display: 'flex', justifyContent: 'center', padding: '64px 24px 80px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28, maxWidth: 420, width: '100%' }}>
          ...
          <p style={{ ...SERIF, fontSize: 22, fontWeight: 300, color: '#3D2B1F', margin: 0, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%' }}>
            <Link
              href="/account"
              style={{ ...BODY, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, padding: '16px', background: '#4A3A32', border: '1px solid #4A3A32', color: '#fff', fontSize: 11, fontWeight: 600, letterSpacing: '0.28em', textTransform: 'uppercase', textDecoration: 'none', transition: 'background 0.3s' }}
            >
              Sign In Again
            </Link>
            ...
            <Link
              href="/energy-quiz"
              style={{ ...BODY, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, padding: '16px', background: 'transparent', border: `1px solid ${GOLD}`, color: '#4A3A32', fontSize: 11, fontWeight: 600, letterSpacing: '0.28em', textTransform: 'uppercase', textDecoration: 'none', transition: 'background 0.3s' }}
            >
